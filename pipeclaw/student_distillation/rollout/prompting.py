...
def build_prompt_case(
    ...
    *,
    ...
    """Build a production-shaped prompt without exposing teacher future messages."""

    if not isinstance(record, Mapping):
        raise TypeError("evaluation record must be a mapping")
    user_input = _user_input(record)
    ...
    messages = _messages(record, user_input, system_prompt)
